...
?>
<form action="http://192.168.64.2/prontopizza.php" method="post">

    <b>Select Your Items</b>

    <p>Plain Cheese
        <input type="checkbox" name="orderLineItem" size="30" value="Plain Cheese" />
    </p>

    <p>Buffalo Wings
        <input type="checkbox" name="orderLineItem" size="30" value="Buffalo Wings" />
    </p>

    <p>French Fries
        <input type="checkbox" name="orderLineItem" size="30" value="French Fries" />
    </p>

    <p>Mozzarella Sticks
        <input type="checkbox" name="orderLineItem" size="30" value="Mozzarella Sticks" />
    </p>

    <p>Pepperoni Pizza
        <input type="checkbox" name="orderLineItem" size="30" value="Pepperoni Pizza" />
    </p>
